    ...
    <main className="max-w-2xl mx-auto px-8 py-16 md:py-24">
      ...
      <section className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg">
          I'll have your audit ready within 48-72 hours.
        </p>
      </section>
      ...
      {formState !== 'success' ? (
        <section className="bg-brand-card rounded-2xl p-6 md:p-8">
          ...
          <p className="text-gray-400 mb-6">
            Fill this out so I can give you the best possible review.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="goals" className="block text-gray-300 text-sm mb-2">What are you trying to achieve? *</label>
              <textarea
                id="goals"
                name="goals"
                ...
                required
                rows={3}
                placeholder="e.g., Grow to 10k followers, build an audience for my business, etc."
            ...
            <div>
              <label htmlFor="specific_questions" className="block text-gray-300 text-sm mb-2">Anything specific you want me to look at?</label>
              <textarea
        ...
        <section className="bg-brand-card rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-400">
            I've got everything I need. You'll receive your audit within 48-72 hours.
          </p>
        </section>
      )}
    </main>
