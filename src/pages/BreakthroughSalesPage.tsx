    ...
    <main className="min-h-screen bg-brand-dark">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-12 md:pt-16 pb-8">
        <div className="flex flex-col items-center">
          <div className="relative mb-4">
            <h2 className="font-soehne font-extrabold text-3xl md:text-5xl text-white whitespace-nowrap relative z-10">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-10">
          <h1 className="font-soehne font-extrabold text-3xl md:text-5xl text-white mb-6 leading-tight">
      ...
      <section className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-brand-card rounded-2xl p-8 md:p-10">
          <h2 className="font-soehne font-extrabold text-2xl text-white mb-6">
      ...
      {/* What You'll Learn */}
      <section className="max-w-3xl mx-auto px-6 py-12">
        <h2 className="font-soehne font-extrabold text-2xl md:text-3xl text-white mb-2">
