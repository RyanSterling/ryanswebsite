...
// Complete Form Data
export interface BreakthroughFormData {
...
export function createEmptyFormData(): BreakthroughFormData {
...
export function isAllComplete(data: BreakthroughFormData): boolean {
  return (
